...
import Prototurk from "../images/prototurkyoutubechannel.png";
...
Bu anket ders esnasında sorulmuştur.`,
  ...
  },
  {
    id: "1708632465282150796",
    type: "photo",
    content: `Merhabalar, bugün Prototurk kanalının katkılarıyla hazırladığım klon twitter projesini bitirmiş bulunuyorum. Tayfun hocaya verdiği bilgiler ve emeklerinden ötürü teşekkür ederim.`,
    photos: [{ Prototurk }],
    account: {
      avatar: { TwitterEggAvatar },
