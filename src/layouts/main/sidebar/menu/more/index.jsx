...
export default function More() {
  return (
    <Popover className="relative">
      ...
      <Popover.Panel>
        <div className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden">
          <button
            className={
              "px-4 h-14 w-full transition-colors inline-flex items-center gap-5 group-hover:bg-[#eff3f41a]"
            }
          >
            <div className="w-[26.25px] h-[26.25px] relative">
              <svg
          ...
          >
            ...
            <div className="pr-4 text-xl font-bold">Konuşma Odası Oluştur</div>
          </button>
          <button
            className={
              "px-4 h-14 w-full transition-colors inline-flex items-center gap-5 group-hover:bg-[#eff3f41a]"
